...
class RoundRobinLdap:
    ...
    def is_master(self):
        """
        Return whether the current server is a master node.
    ...
    def get_result(self):
        """
        Return the previous query results.
    ...
    def get_results(self):
        """
        Return the previous query list of results.
        :returns: The query list of results
        """
